...
# generate sine-like function samples 正弦波形
...
# generate sigmoid-like function samples S 形波形
...
class SimpleClassificationRNN(nn.Module):
    def __init__(self, hidden_size):
        ...
        '''
        # 定义一个RNN层，输入维度为1，隐藏层维度为hidden_size，batch_first=True，num_layers=1
        self.rnn = nn.RNN(input_size=1,
                          hidden_size=hidden_size,
                          batch_first=True,
                          num_layers=1)
        # 定义一个全连接层，输入维度为hidden_size，输出维度为1
